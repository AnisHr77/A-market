...
function Help() {
  ...
  const backgroundImage = "https://static.vecteezy.com/system/resources/previews/004/697/690/non_2x/blue-white-shapes-background-abstract-with-halftone-free-vector.jpg";
  ...
  return (
    ...
    style={{
      backgroundImage: `url('https://static.vecteezy.com/system/resources/previews/004/697/690/non_2x/blue-white-shapes-background-abstract-with-halftone-free-vector.jpg')`,

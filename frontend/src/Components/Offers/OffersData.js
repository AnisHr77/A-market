...
const offersData = [
    {
        ...
        icon: <FaRegHeart  style={{position:'relative',right:'2px',top:'2px ',height:'22px'}}/>,
        title: ['MacBook pro','Keyboard Rgb'],
        price: [462.2,50],
        description: "4pcs Universal Algerian Vintage",
        oldprice: [520,70],
    ...
    },
    {
        ...
        price: [462.2,50],
        countdown: ['20min left', '1min 30s left'],
        width:['40%','40%'], // asm3 matghltch dir 50% hya akbar 9ima 50% kichghol 100% tsma 9sm l9ima ta3k 3la zouj
        image: ['https://imagedelivery.net/JAV112JY973Crznn4xb8Sg/109153dc-03f7-4c92-178d-cfecb4ce7200/mobile','https://media.hardware.fr/r500/ld/products/00/06/08/23/LD0006082315.jpg']
    },
    {
        id: "3",
        category: 'BigSave',
